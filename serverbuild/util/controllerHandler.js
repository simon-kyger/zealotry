...
exports.__RewireAPI__ = exports.__ResetDependency__ = exports.__set__ = exports.__Rewire__ = exports.__GetDependency__ = exports.__get__ = exports.socketControllerHandler = exports.apiControllerHandler = undefined;
 ...
 */
const apiControllerHandler = exports.apiControllerHandler = (promise, params) => (() => {
  var _ref = _asyncToGenerator(function* (req, res, next) {
    ...
    try {
      ...
      if (error instanceof _get__('ApiError')) {
 ...
 */
const socketControllerHandler = exports.socketControllerHandler = (() => {
  var _ref2 = _asyncToGenerator(function* (promise, params, success, failure) {
    success = success || _get__('noop');
    failure = failure || _get__('noop');
    try {
      const result = yield promise(...params);
  ...
  return function socketControllerHandler(_x4, _x5, _x6, _x7) {
